...
def model_attention_applied_after_lstm(time_steps, input_dim, output_dim):
    inputs = Input(shape=(time_steps, input_dim,))
    lstm_units = 32
    lstm_out = LSTM(lstm_units, return_sequences=True, dropout=0.1, recurrent_dropout=0.1)(inputs)
